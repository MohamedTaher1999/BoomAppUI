...
class ExportHorizntalAdapter(private val mList: List<String>, val context: Context, private val clickListener: RecyclerViewClickListener) : RecyclerView.Adapter<ExportHorizntalAdapter.ViewHolder>() {
